...
public class VtfLoader {
    ...
    public void load(String string) {
        ...
        try {
          bin = new RandomAccessFile("./test.dat", "rw");
          bin.writeByte(135);
          bin.close();

          bin = new RandomAccessFile("test.dat", "r");
          int b = bin.readUnsignedByte();
          bin.close();
    ...
    public static void main(String... args) {
        new VtfLoader().load("/home/andrew/NetBeansProjects/tf2-hud-editor/src/com/timepath/tf2/hudedit/images/eng_status_area_tele_blue.vtf");
    }
